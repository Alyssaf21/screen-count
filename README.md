...
_Renumber_ updates the numbers on your screen labels based on position (objects at the top are first, then left, right, and bottom). 

Just add the name of the label container, select the flow or frames you want to update, and hit "Renumber".  
